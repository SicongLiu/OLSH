...
qn=20
c0=2
temporalResult=../H2_ALSH/qhull_data/Mathematica/run_test_anti_correlated_2_10000
overallResult=../H2_ALSH/qhull_data/Mathematica/overall_run_test_anti_correlated_2_10000.txt
S=0.9
num_layer=10
# ------------------------------------------------------------------------------ 
#     Ground-Truth 
