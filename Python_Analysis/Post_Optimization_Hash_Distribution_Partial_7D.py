...
for i in range(len(dimensions)):
    ...
    for wwss in wss:
        ...
        if top_m_anti == 14:
            ...
            data_anti_list = data_anti_list_14
            ...
            data_corr_list = data_corr_list_17
            ...
            hash_used_rand_opt_cells = hash_used_rand_opt_cells_13
            hash_used_rand_uni_cells = hash_used_rand_uni_cells_13
            data_random_list = data_random_list_13
            ...
            data_random_list = data_random_list_17
            ...
            top_m_cardinality_random = ws[top_m_cardinality_random_cell].value
            hash_used_rand_opt_cells = hash_used_rand_opt_cells_21
            hash_used_rand_uni_cells = hash_used_rand_uni_cells_21
            data_random_list = data_random_list_21
            ...
            top_m_cardinality_corr_cell = 'AA32'
            top_m_cardinality_corr = ws[top_m_cardinality_corr_cell].value
            hash_used_corr_opt_cells = hash_used_corr_opt_cells_26
            hash_used_corr_uni_cells = hash_used_corr_uni_cells_26
            data_corr_list = data_corr_list_26
            ...
            top_m_cardinality_anti_cell = 'J30'
            top_m_cardinality_anti = ws[top_m_cardinality_anti_cell].value
            hash_used_anti_opt_cells = hash_used_anti_opt_cells_24
            hash_used_anti_uni_cells = hash_used_anti_uni_cells_24
            data_anti_list = data_anti_list_24
            ...
            top_m_cardinality_random_cell = 'AQ29'
            top_m_cardinality_random = ws[top_m_cardinality_random_cell].value
            hash_used_rand_opt_cells = hash_used_rand_opt_cells_23
            hash_used_rand_uni_cells = hash_used_rand_uni_cells_23
            data_random_list = data_random_list_23
            ...
            top_m_cardinality_corr_cell = 'AA35'
            top_m_cardinality_corr = ws[top_m_cardinality_corr_cell].value
            hash_used_corr_opt_cells = hash_used_corr_opt_cells_29
            hash_used_corr_uni_cells = hash_used_corr_uni_cells_29
            data_corr_list = data_corr_list_29
            ...
            top_m_cardinality_random_cell = 'AQ22'
            top_m_cardinality_random = ws[top_m_cardinality_random_cell].value
            hash_used_rand_opt_cells = hash_used_rand_opt_cells_16
            hash_used_rand_uni_cells = hash_used_rand_uni_cells_16
            data_random_list = data_random_list_16
            ...
            top_m_cardinality_anti_cell = 'J32'
            top_m_cardinality_anti = ws[top_m_cardinality_anti_cell].value
            hash_used_anti_opt_cells = hash_used_anti_opt_cells_26
            hash_used_anti_uni_cells = hash_used_anti_uni_cells_26
            data_anti_list = data_anti_list_26
            ...
            top_m_cardinality_corr_cell = 'AA37'
            top_m_cardinality_corr = ws[top_m_cardinality_corr_cell].value
            hash_used_corr_opt_cells = hash_used_corr_opt_cells_31
            hash_used_corr_uni_cells = hash_used_corr_uni_cells_31
            data_corr_list = data_corr_list_31
        ...
        for jj in range(types.__len__()):
            ...
            l_anti_opt = post_optimization_opt_revised(collision_probility_anti, weight_anti, total_error, data_anti, k_anti,
                                               l_anti_opt,
                                               hash_used_anti_opt, hash_budget_anti)
            l_corr_opt = post_optimization_opt_revised(collision_probility_corr, weight_corr, total_error, data_corr, k_corr,
                                               l_corr_opt,
                                               hash_used_corr_opt, hash_budget_corr)
            l_random_opt = post_optimization_opt_revised(collision_probility_random, weight_random, total_error, data_random, k_anti,
                                                 l_random_opt,
                                                 hash_used_random_opt, hash_budget_rand)
