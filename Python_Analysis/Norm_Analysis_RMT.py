...
# RMT_data_size = 30
# RMT_data_folder = "/Users/sicongliu/Downloads/Features_RMT/"
# total_feature = []
...
# save_folder = "/Users/sicongliu/Desktop/StreamingTopK/H2_ALSH/raw_data/Synthetic/"
...
file_name = data_folder + data_type + str(dimension) + '_' + str(cardinality)
f = open(file_name, 'r')
lines = f.readlines()
