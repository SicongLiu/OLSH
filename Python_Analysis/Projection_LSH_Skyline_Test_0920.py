...
def load_skyline_data(skyline_file_, card_, projected_dim_):
...
for ii in range(dim_list.__len__()):
    ...
    for jj in range(query_size):  # for each query compute top-k, use map for cache
        ...
        for kk in range(top_k):
            ...
            skyline_data, skyline_size = load_skyline_data(skyline_file, cardinality, projected_dim)
