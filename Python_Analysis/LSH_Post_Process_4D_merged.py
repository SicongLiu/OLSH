...
for dd in range(dimensions.__len__()):
    ...
    cur_card_anti = card[0]
    cur_card_anti = card[1]
    cur_card_anti = card[2]
                ...
                for ct in range(comp_types.__len__()):
                    ...
                    for tt in range(types.__len__()):
                        ...
                        obj_file_dir = result_file_dir + obj_hashsize_prefix + str(cur_dimension) + 'D_top' + \
                                    str(cur_top_o) + '_' + cur_type + '_' + str(card_file_name) + '/'
                        ...
                        actual_length = obj_s.__len__()
                        for oh_index in range(actual_length):
                        ...
                        spec_string = 'cardinality: ' + str(card) + ', dimension: ' + str(cur_dimension) +\
                        ...
                        for ee in range(top_ks_length):
                            ...
                            f.write(str(obj[actual_length - 1]) + ', ')
                            f.write(str(hash[actual_length - 1]) + ', ')
                            f.write('\n')
                        f.write('\n')
                        f.write('\n')
                        ...
                        for ee in range(top_ks_length):
                            ...
                            ws[obj_cell] = float(obj[actual_length - 1])
                            ws[hashsize_cell] = float(hash[actual_length - 1])
                        for ee in range(top_ks_length):
